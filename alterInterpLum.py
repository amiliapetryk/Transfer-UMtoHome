...
for temp in tempList:
	...
	#print("sameHdenTempRadList is {}".format(sameHdenTempRadList))
	#print("sameHdenTempIonList is {}".format(sameHdenTempIonList))
	...
	for array in sameHdenTempIonList:
		...
		for num in array:
			...
			if abs(num-neutralFrac) == diff:
				...
				counter += 1
	#print("valueList is {}".format(valueList))
	#print("sameHdenTempRadList[0][valueList[0]] is {}".format(sameHdenTempRadList[0][valueList[0]]))
	#print("sameHdenTempIonList[0][valueList[0]] is {}".format(sameHdenTempIonList[0][valueList[0]]))
	
	#print("sameHdenTempRadList[1][valueList[1]] is {}".format(sameHdenTempRadList[1][valueList[1]]))
	#print("sameHdenTempIonList[1][valueList[1]] is {}".format(sameHdenTempIonList[1][valueList[1]]))
	
	#print("sameHdenTempRadList[2][valueList[2]] is {}".format(sameHdenTempRadList[2][valueList[2]]))
	#print("sameHdenTempIonList[2][valueList[2]] is {}".format(sameHdenTempIonList[2][valueList[2]]))
	
	#print("sameHdenTempRadList[3][valueList[3]] is {}".format(sameHdenTempRadList[3][valueList[3]]))
	#print("sameHdenTempIonList[3][valueList[3]] is {}".format(sameHdenTempIonList[3][valueList[3]]))
	
	#print("sameHdenTempRadList[4][valueList[4]] is {}".format(sameHdenTempRadList[4][valueList[4]]))
	#print("sameHdenTempIonList[4][valueList[4]] is {}".format(sameHdenTempIonList[4][valueList[4]]))
	
	#sameHdenTempRadArray = np.array(sameHdenTempRadList)
	...
	altInterpValue = np.interp(0.5,interpIonList,lumList)
	...
	radCounter = 0
	for num in sameHdenTempRadList[0]:
		if radCounter == valueList[0]:
			interpRadList.append(num)
			
		radCounter += 1
		
	radCounter = 0
	for num in sameHdenTempRadList[1]:
		if radCounter == valueList[1]:
			interpRadList.append(num)
			
		radCounter += 1
		
	radCounter = 0
	for num in sameHdenTempRadList[2]:
		if radCounter == valueList[2]:
			interpRadList.append(num)
			
		radCounter += 1
		
	radCounter = 0
	for num in sameHdenTempRadList[3]:
		if radCounter == valueList[3]:
			interpRadList.append(num)
			
		radCounter += 1
		
	radCounter = 0
	for num in sameHdenTempRadList[4]:
		if radCounter == valueList[4]:
			interpRadList.append(num)
